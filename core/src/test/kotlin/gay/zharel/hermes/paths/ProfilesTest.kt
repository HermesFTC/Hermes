...
class ProfilesTest {
  ...
  @Test
  fun testSimpleProfile() = saveProfiles(
    "simpleProfile",
    TimeProfile(
  ...
  @Test
  fun testForwardProfileComplex() = saveProfiles(
    "forwardProfile",
    TimeProfile(
  ...
  @Test
  fun testBackwardProfileComplex() = saveProfiles(
    "backwardProfile",
    TimeProfile(
  ...
  @Test
  fun testProfileComplex() = saveProfiles(
    "profile",
    TimeProfile(
  ...
  @Test
  fun testProfileComplexNonZeroMin() = saveProfiles(
    "profileNonZero",
    TimeProfile(
      createVoltageConstrainedProfile(
        10.0,
  ...
  @Test
  fun testProfileComplexNonZeroMinCancel() = saveProfiles(
  ...
  @Test
  fun testSimpleAsymmetricProfile() = saveProfiles(
    "asymmetricProfile",
    TimeProfile(
  ...
  @Test
  fun testSemicircleProfile() = saveProfiles(
    "semicircleProfile",
    TimeProfile(
      TrajectoryBuilder(
  ...
  @Test
  fun testSemicircle2Profile() = saveProfiles(
    "semicircle2Profile",
    TimeProfile(
      TrajectoryBuilder(
        TEST_TRAJECTORY_BUILDER_PARAMS,
