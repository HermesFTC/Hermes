...
data class SwerveKinematics(
  ...
  override fun <Param : DualParameter> forward(
    velocities: SwerveWheelVelocities<*>,
  ...
  override fun <Param : DualParameter> inverse(
    velocity: PoseVelocity2dDual<Param>,
  ): SwerveWheelVelocities<Param> {
