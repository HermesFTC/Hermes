 ...
 */
@Serializable
data class Vector2dDual<Param : DualParameter>(
  @JvmField val x: DualNum<Param>,
  @JvmField val y: DualNum<Param>,
) {
  companion object {
    @JvmStatic
...
fun <Param : DualParameter> lerpVector2dDual(
  start: Vector2dDual<Param>,
  end: Vector2dDual<Param>,
  t: Double,
): Vector2dDual<Param> {
