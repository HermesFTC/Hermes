 ...
 */
@Serializable
data class Rotation2dDual<Param : DualParameter>(
  @JvmField val real: DualNum<Param>,
  @JvmField val imag: DualNum<Param>,
) {
  init {
  ...
  companion object {
    ...
    @JvmStatic
    fun <Param : DualParameter> constant(r: Rotation2d, n: Int) = Rotation2dDual<Param>(
      DualNum.Companion.constant(r.real, n),
      DualNum.Companion.constant(r.imag, n),
    )
  ...
  operator fun times(v: Vector2dDual<Param>) = Vector2dDual(
    real * v.x - imag * v.y,
    imag * v.x + real * v.y,
  )
...
fun <Param : DualParameter> lerpRotation2dDual(
  start: Rotation2dDual<Param>,
  end: Rotation2dDual<Param>,
  t: Double,
): Rotation2dDual<Param> = Rotation2dDual.exp(lerpDual(t, 0.0, 1.0, start.log(), end.log()))
