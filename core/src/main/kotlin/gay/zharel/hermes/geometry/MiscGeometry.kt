...
data class PoseVelocity2dDual<Param : DualParameter>(
  ...
  companion object {
    @JvmStatic
    fun <Param : DualParameter> constant(pv: PoseVelocity2d, n: Int) = PoseVelocity2dDual<Param>(
      Vector2dDual.constant(pv.linearVel, n),
      DualNum.constant(pv.angVel, n),
    )
  ...
  operator fun plus(other: PoseVelocity2d) = PoseVelocity2dDual(
    linearVel + other.linearVel,
    angVel + other.angVel,
  )
