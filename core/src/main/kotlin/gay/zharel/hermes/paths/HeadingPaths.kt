...
data class TangentHeadingPath(
  ...
  override fun get(s: Double, n: Int): Rotation2dDual<Arclength> =
    posPath[s, n + 1].drop(1).angleCast() + offset
...
data class SplineHeadingPath(
  ...
  override fun get(s: Double, n: Int) = Rotation2dDual.Companion.exp(
    spline[s / length, n]
      .reparam(
        // t(s) = s / len
