...
data class Line(
  ...
  override fun get(param: Double, n: Int) = DualNum.variable<Arclength>(param, n) * dir + begin
...
data class ArclengthReparamCurve2d(
  ...
  fun reparam(s: Double): Double = lerpLookup(samples.sums, samples.values, s)
...
private fun <Param : DualParameter> PositionPath<Param>.wrtArclength(): PositionPath<Arclength> =
  when (this) {
    is Line -> this
