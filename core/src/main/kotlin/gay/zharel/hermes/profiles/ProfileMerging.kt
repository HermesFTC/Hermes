 ...
 */
private fun interpolateVelocityBackward(endVel: Double, acceleration: Double, distance: Double): Double {
...
private fun shouldCreateTransitionPoint(
  ...
  accel1: Double,
  accel2: Double,
): Boolean = currentMinIsFromP1 != lastMinWasFromP1 && accel1 != accel2
