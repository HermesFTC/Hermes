...
class SafePosePathBuilder internal constructor(private val posePathSeqBuilder: PosePathSeqBuilder) {
  ...
  fun tangentUntil(disp: Double) = RestrictedPosePathBuilder(posePathSeqBuilder.tangentUntil(disp))
  fun constantUntil(disp: Double) = RestrictedPosePathBuilder(posePathSeqBuilder.constantUntil(disp))
...
class SafeTrajectoryBuilder internal constructor(private val trajBuilder: TrajectoryBuilder) {
  ...
  fun splineTo(
    ...
    trajBuilder.splineTo(pos, tangent, velConstraintOverride, accelConstraintOverride),
  )
