...
class DifferentialTrajectoryBuilder internal constructor(
   ...
   */
  fun setTangent(r: Rotation2d) = DifferentialTrajectoryBuilder(builder.setTangent(r.hermes), kinematics)

  /**
   * Sets the starting tangent of the next path segment.
   * See [RoadRunner docs](https://rr.brott.dev/docs/v1-0/guides/tangents/).
   */
  fun setTangent(r: Double) = DifferentialTrajectoryBuilder(builder.setTangent(r), kinematics)
   ...
   * as the remaining control points.
   */
  fun bezierTo(vararg controlPoints: Translation2d) = DifferentialTrajectoryBuilder(
