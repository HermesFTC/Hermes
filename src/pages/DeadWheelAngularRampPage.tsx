...
const DeadWheelAngularRampPage: React.FC = () => {
  return (
    <div className="content p-6 w-full max-w-7xl mx-auto">
      <header className="mb-8">
        <h1 className="text-3xl font-bold mb-2">RR Dead Wheel Angular Ramp Regression</h1>
...
export default DeadWheelAngularRampPage; 