  ...
  return (
    <div>
      ...
      <div className="text-left">
        <span>
          <p>
            Place the robot on the edge of one of your tiles. Press the button
    ...
    <GenericButton href="/hermes/lateral-push" className={"p-4 rounded-xl mt-10 transition duration-500 " + (hasRun ? "opacity-100" : "none opacity-0") }>I'm ready to move on!</GenericButton>
